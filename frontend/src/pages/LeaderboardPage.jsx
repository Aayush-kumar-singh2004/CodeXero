    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1e1b4b] to-[#121212] text-gray-200 font-urbanist">
      <div className="max-w-7xl mx-auto px-6 pt-28 pb-20 flex flex-col items-center">
        ...
        <button
          ...
          className="absolute top-6 left-6 flex items-center gap-2 px-4 py-2 rounded-xl bg-[#1f1f1f]/60 hover:bg-indigo-500/20 border border-gray-600 hover:border-indigo-400 text-gray-300 hover:text-indigo-300 font-semibold shadow transition-all duration-300 group z-20"
        ...
        {/* Empty State */}
        {!leaderboard.length && !loading && !error && (
